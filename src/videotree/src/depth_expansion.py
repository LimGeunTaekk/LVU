...
def depth_expansion():
    ...
    base_path = Path('./data/egoschema/egoschema_frames')
    save_folder = './data/egoschema/frame_features'

    rel_path = './outputs/dynamic_width_expansion/relevance_score.json'
    with open(rel_path, 'r') as file:
        cap_score_data = json.load(file)

    width_res_path = './outputs/dynamic_width_expansion/width_res.json'
    ...
    with open('./data/egoschema/subset_answers.json', 'r') as file:
    ...
    for example_path in example_path_list:
        ...
        closest_points_temporal_subsub = find_closest_points_in_temporal_order_subsub(img_feats.to(torch.float32), clusters_info,relevance_scores)
    ...
    save_json(all_data, './outputs/dynamic_width_expansion/depth_expansion_res.json')
